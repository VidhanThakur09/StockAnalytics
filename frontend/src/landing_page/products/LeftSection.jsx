  ...
  return (
    <div className="container my-5">
      <div className="row d-flex align-items-center"> {/* Added d-flex and align-items-center for vertical alignment */}
        <div className="col-12 col-md-6 p-3 order-md-1"> {/* On small screens, takes full width, then 6 on md and up. Order for md and up */}
          <img src={imageUrl} className="img-fluid"/> {/* Added img-fluid for responsive images */}
        </div>
        <div className="col-12 col-md-5 mt-md-5 p-3 order-md-2"> {/* On small screens, takes full width, then 5 on md and up. Order for md and up */}
          <h1>{productName}</h1>
