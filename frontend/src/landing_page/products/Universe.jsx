    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img  style={{"width":"50%" , "marginBottom":"10px"}} src="images/zerodhaFundhouse.png" />
          <p className="text-small text-muted">Our asset management venture
that is creating simple and transparent index
funds to help you save for your goals.</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img  style={{"width":"50%", "marginBottom":"10px"}} src="images/sensibullLogo.svg" />
        ...
        <div className="col-4 p-3 mt-5">
          <img  style={{"width":"50%", "marginBottom":"10px"}} src="images/tijori.svg" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{"width":"50%", "marginBottom":"10px"}} src="images/streakLogo.png" />
        ...
        <div className="col-4 p-3 mt-5">
          <img style={{"width":"50%", "marginBottom":"10px"}} src="images/smallcaseLogo.png" />
        ...
        <div className="col-4 p-3 mt-5">
          <img  style={{"width":"50%", "marginBottom":"10px"}} src="images/dittoLogo.png" />
